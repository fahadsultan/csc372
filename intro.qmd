...
Training is the process of finding values of $\theta$ that make the model useful for a particular task.
...
Regression models predict a continuous output variable based on one or more input variables. For instance, the top panel shows a regression model that takes a vector of numbers that characterize a property and predicts its price.

For instance the top panel shows a regression model that takes a vector of numbers that characterize a property and predicts its price.
...
In unsupervised learning, the training data contain inputs but no supplied target outputs:
...
<img src="assets/Chap01/IntroSynthesis.svg">
...
<img src="assets/Chap01/IntroVariety.svg">
