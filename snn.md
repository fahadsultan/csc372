...
<img src="assets/Chap03/ShallowReLU.svg" style="filter: invert(1);" width="100%">
...
<img src="assets/Chap03/ShallowApproximate.svg" style="filter: invert(1);">
...
Visualization of how a shallow neural network builds up a piecewise linear approximation in 2D.Processing in network with two inputs x = [x1, x2]T , three hidden units h1, h2, h3, and one output y. a–c) The input to each hidden unit is a
